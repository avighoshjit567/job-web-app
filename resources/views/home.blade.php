...
<head>
    ...
    <body class="dark:bg-slate-900">
            ...
            <div class="container">
                ...
                <a class="logo" href="index.html">
                    <div class="block sm:hidden">
                        <img src="{{ asset('web-assets/images/logo-icon-40.png') }}" class="h-10 inline-block dark:hidden"  alt="">
                        <img src="{{ asset('web-assets/images/logo-icon-40-white.png') }}" class="h-10 hidden dark:inline-block"  alt="">
                    </div>
                    <div class="sm:block hidden">
                        <img src="{{ asset('web-assets/images/logo-dark.png') }}" class="h-[24px] inline-block dark:hidden" alt="">
                        <img src="{{ asset('web-assets/images/logo-white.png') }}" class="h-[24px] hidden dark:inline-block" alt="">
                    </div>
                </a>
                <!-- End Logo container-->
                    ...
                    <ul class="navigation-menu">
                        <li class="has-submenu parent-menu-item">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="index-nine.html" class="sub-menu-item">Hero Nine</a></li>
                                <li><a href="index-ten.html" class="sub-menu-item">Hero Ten </a></li>
                            </ul>
                        </li>
        ...
        <!-- Start -->
        <section class="relative py-36 table w-full bg-gradient-to-b from-emerald-600/20 dark:from-emerald-600/40 via-emerald-600/10 dark:via-emerald-600/20 to-transparent">
            <div class="container">
                <div class="grid md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
                    <div class="md:order-1 order-2">
                        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm dark:shadow-gray-800 md:p-8 p-6 lg:me-10 relative">
                            <h4 class="mb-3 text-3xl font-semibold">Find Your Expected Job</h4>
                            <p class="text-slate-400">Find Jobs, Employment & Career Opportunities. Some of the companies we've helped recruit excellent applicants over the years.</p>
                                ...
                                <div class="grid grid-cols-1">
                                    <div class="mb-4">
                                        ...
                                        <div class="filter-search-form relative mt-2">
                                            ...
                                            <input name="name" type="text" id="job-keyword" class="form-input filter-input-box !bg-gray-50 dark:!bg-slate-800" placeholder="Search your Keywords">
                                        </div>
                                    </div>
            ...
            <div class="container mt-16">
                <div class="grid md:grid-cols-10 sm:grid-cols-5 grid-cols-4 justify-center gap-[30px]">
                    <div class="size-12 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 flex justify-center items-center rounded-md mx-auto py-4">
            ...
            <div class="container">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-6 gap-[30px]">
                    <div class="p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 transition duration-500 rounded-2xl mt-6 text-center">
                        <div class="size-14 bg-emerald-600/5 text-emerald-600 rounded-xl text-2xl flex align-middle justify-center items-center mx-auto shadow-xs dark:shadow-gray-800">
                    ...
                    <div class="p-6 shadow-xl shadow-gray-100 dark:shadow-gray-800 transition duration-500 rounded-2xl mt-6 text-center">
                        ...
                        <div class="content mt-7">
                            <a href="#" class="title h5 text-lg font-semibold hover:text-emerald-600">Complete Your Profile</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    ...
                    <div class="p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 transition duration-500 rounded-2xl mt-6 text-center">
                        ...
                        <div class="content mt-7">
                            <a href="#" class="title h5 text-lg font-semibold hover:text-emerald-600">Apply Job or Hire</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                            ...
                            <div class="grid grid-cols-12 gap-6 items-center">
                                <div class="col-span-6">
                                    <div class="grid grid-cols-1 gap-6">
                                        <img src="{{ asset('web-assets/images/about/ab03.jpg') }}" class="shadow-sm rounded-md" alt="">
                                        <img src="{{ asset('web-assets/images/about/ab02.jpg') }}" class="shadow-sm rounded-md" alt="">
                                    </div>
                                </div>
    
                                <div class="col-span-6">
                                    <div class="grid grid-cols-1 gap-6">
                                        <img src="{{ asset('web-assets/images/about/ab01.jpg') }}" class="shadow-sm rounded-md" alt="">
                                    </div>
                                </div>
                            </div>
    
                            <div class="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                                <a href="#!" data-type="youtube" data-id="S_CGed6E610" class="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-emerald-600 dark:text-white">
                    ...
                    <div class="lg:col-span-7 md:col-span-6">
                        <div class="lg:ms-8">
                            <h3 class="mb-6 md:text-4xl text-3xl md:leading-normal leading-normal font-bold">Get the job of you dreams <br> quick & easy.</h3>
                            ...
                            <ul class="list-none text-slate-400 mt-4">
                                <li class="mb-1 flex"><i class="uil uil-check-circle text-emerald-600 text-xl me-2"></i> Digital Marketing Solutions for Tomorrow</li>
                                <li class="mb-1 flex"><i class="uil uil-check-circle text-emerald-600 text-xl me-2"></i> Our Talented & Experienced Marketing Agency</li>
                                <li class="mb-1 flex"><i class="uil uil-check-circle text-emerald-600 text-xl me-2"></i> Create your own skin to match your brand</li>
                            </ul>
                        
                            <div class="mt-6">
                                <a href="contact.html" class="py-1 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white mt-2 rounded-md"><i class="uil uil-envelope"></i> Contact us</a>
                            </div>
                        </div>
                    </div>
                </div><!--end grid-->
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid md:grid-cols-12 grid-cols-1 pb-8 items-end">
                    <div class="lg:col-span-8 md:col-span-6 md:text-start text-center">
                        <h3 class="mb-4 md:text-[26px] md:leading-normal text-2xl leading-normal font-semibold">Browse by Categories</h3>
                ...
                <div class="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <div class="group p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-slate-50 dark:bg-slate-800 hover:bg-emerald-600 dark:hover:bg-emerald-600 transition-all duration-500">
                        ...
                        <div class="mt-2">
                            <a href="job-grid-one.html" class="text-emerald-600 dark:text-white/80 group-hover:text-white font-medium">Explore Jobs <i class="uil uil-arrow-right"></i></a>
                        </div>
                    </div><!--end content-->
                    ...
                    <div class="group p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-slate-50 dark:bg-slate-800 hover:bg-emerald-600 dark:hover:bg-emerald-600 transition-all duration-500">
                        ...
                        <div class="mt-2">
                            <a href="job-grid-two.html" class="text-emerald-600 dark:text-white/80 group-hover:text-white font-medium">Explore Jobs <i class="uil uil-arrow-right"></i></a>
                        </div>
                    </div><!--end content-->
                    ...
                    <div class="group p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-slate-50 dark:bg-slate-800 hover:bg-emerald-600 dark:hover:bg-emerald-600 transition-all duration-500">
                        ...
                        <div class="mt-2">
                            <a href="job-grid-three.html" class="text-emerald-600 dark:text-white/80 group-hover:text-white font-medium">Explore Jobs <i class="uil uil-arrow-right"></i></a>
                        </div>
                    </div><!--end content-->
                    ...
                    <div class="group p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-slate-50 dark:bg-slate-800 hover:bg-emerald-600 dark:hover:bg-emerald-600 transition-all duration-500">
                        ...
                        <div class="mt-2">
                            <a href="job-list-three.html" class="text-emerald-600 dark:text-white/80 group-hover:text-white font-medium">Explore Jobs <i class="uil uil-arrow-right"></i></a>
                        </div>
                    </div><!--end content-->
                    ...
                    <div class="group p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-slate-50 dark:bg-slate-800 hover:bg-emerald-600 dark:hover:bg-emerald-600 transition-all duration-500">
                        ...
                        <div class="mt-2">
                            <a href="job-list-two.html" class="text-emerald-600 dark:text-white/80 group-hover:text-white font-medium">Explore Jobs <i class="uil uil-arrow-right"></i></a>
                        </div>
                    </div><!--end content-->
                    ...
                    <div class="group p-4 rounded-md shadow-sm dark:shadow-gray-700 bg-slate-50 dark:bg-slate-800 hover:bg-emerald-600 dark:hover:bg-emerald-600 transition-all duration-500">
                        ...
                        <div class="mt-2">
                            <a href="job-list-one.html" class="text-emerald-600 dark:text-white/80 group-hover:text-white font-medium">Explore Jobs <i class="uil uil-arrow-right"></i></a>
                        </div>
                    </div><!--end content-->
            ...
            <div class="container md:mt-24 mt-16">
                ...
                <div class="grid grid-cols-1 mt-8 gap-[30px]">
                    <div class="group relative overflow-hidden md:flex justify-between items-center rounded shadow-sm hover:shadow-md dark:shadow-gray-700 transition-all duration-500 p-5">
                        <div class="flex items-center">
                            <div class="size-14 flex items-center justify-center bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 rounded-md">
                                <img src="{{ asset('web-assets/images/company/facebook-logo.png') }}" class="size-8"  alt="">
                            </div>
                            <a href="job-detail-one.html" class="text-lg hover:text-emerald-600 font-semibold transition-all duration-500 ms-3 min-w-[180px]">Web Designer</a>
                        </div>
                        ...
                        <div class="md:mt-0 mt-4">
                            ...
                            <a href="job-apply.html" class="py-1 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white md:ms-2 w-full md:w-auto">Apply Now</a>
                        </div>
                    ...
                    <div class="group relative overflow-hidden md:flex justify-between items-center rounded shadow-sm hover:shadow-md dark:shadow-gray-700 transition-all duration-500 p-5">
                        <div class="flex items-center">
                            <div class="size-14 flex items-center justify-center bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 rounded-md">
                                <img src="{{ asset('web-assets/images/company/google-logo.png') }}" class="size-8"  alt="">
                            </div>
                            <a href="job-detail-one.html" class="text-lg hover:text-emerald-600 font-semibold transition-all duration-500 ms-3 min-w-[180px]">Marketing Director</a>
                        </div>
                    ...
                    <div class="group relative overflow-hidden md:flex justify-between items-center rounded shadow-sm hover:shadow-md dark:shadow-gray-700 transition-all duration-500 p-5">
                        <div class="flex items-center">
                            ...
                            <a href="job-detail-one.html" class="text-lg hover:text-emerald-600 font-semibold transition-all duration-500 ms-3 min-w-[180px]">App Developer</a>
                        </div>
                    ...
                    <div class="group relative overflow-hidden md:flex justify-between items-center rounded shadow-sm hover:shadow-md dark:shadow-gray-700 transition-all duration-500 p-5">
                        <div class="flex items-center">
                            <div class="size-14 flex items-center justify-center bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 rounded-md">
                                <img src="{{ asset('web-assets/images/company/lenovo-logo.png') }}" class="size-8"  alt="">
                            </div>
                            <a href="job-detail-one.html" class="text-lg hover:text-emerald-600 font-semibold transition-all duration-500 ms-3 min-w-[180px]">Product Designer</a>
                        </div>
                    ...
                    <div class="group relative overflow-hidden md:flex justify-between items-center rounded shadow-sm hover:shadow-md dark:shadow-gray-700 transition-all duration-500 p-5">
                        <div class="flex items-center">
                            ...
                            <a href="job-detail-one.html" class="text-lg hover:text-emerald-600 font-semibold transition-all duration-500 ms-3 min-w-[180px]">C++ Developer</a>
                        </div>
                    ...
                    <div class="group relative overflow-hidden md:flex justify-between items-center rounded shadow-sm hover:shadow-md dark:shadow-gray-700 transition-all duration-500 p-5">
                        <div class="flex items-center">
                            <div class="size-14 flex items-center justify-center bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 rounded-md">
                                <img src="{{ asset('web-assets/images/company/linkedin.png') }}" class="size-8"  alt="">
                            </div>
                            <a href="job-detail-one.html" class="text-lg hover:text-emerald-600 font-semibold transition-all duration-500 ms-3 min-w-[180px]">Php Developer</a>
                        </div>
        ...
        <!-- Start -->
        <section class="py-20 w-full table relative bg-[url('../../assets/images/hero/bg2.html')] bg-top bg-no-repeat bg-cover">
            <div class="absolute inset-0 bg-slate-900/70"></div>
            <div class="container relative">
                <div class="grid grid-cols-1 text-center">
                    <h3 class="mb-4 md:text-[26px] text-2xl text-white font-medium">Get the job that's right for you</h3>

                    <p class="text-white/80 max-w-xl mx-auto">Search all the open positions on the web. Get your own personalized salary estimate. Read reviews on over 30000+ companies worldwide.</p>
                
                    <a href="#!" data-type="youtube" data-id="S_CGed6E610" class="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-emerald-600 mx-auto mt-10">
                        <i class="mdi mdi-play inline-flex items-center justify-center text-2xl"></i>
                    </a>
                </div><!--end grid-->
            </div><!--end container-->
        ...
        <section class="relative md:py-24 py-16">
            <div class="container">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    ...
                    <div class="group relative p-6 rounded-md shadow-sm dark:shadow-gray-700 mt-6">
                        <div class="size-14 flex items-center justify-center bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-700 rounded-md relative -mt-12">
                            <img src="{{ asset('web-assets/images/company/shree-logo.png') }}" class="size-8"  alt="">
                        </div>
            ...
            <div class="container md:mt-24 mt-16" style="display: none;">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-md shadow-sm dark:shadow-gray-700">
                        <div class="relative overflow-hidden">
                            <img src="{{ asset('web-assets/images/blog/01.jpg') }}" class="scale-110 group-hover:scale-100 transition-all duration-500" alt="">
                        </div>
                    ...
                    <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-md shadow-sm dark:shadow-gray-700">
                        <div class="relative overflow-hidden">
                            <img src="{{ asset('web-assets/images/blog/02.jpg') }}" class="scale-110 group-hover:scale-100 transition-all duration-500" alt="">
                        </div>
                    ...
                    <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-md shadow-sm dark:shadow-gray-700">
                        <div class="relative overflow-hidden">
                            <img src="{{ asset('web-assets/images/blog/03.jpg') }}" class="scale-110 group-hover:scale-100 transition-all duration-500" alt="">
                        </div>
                            ...
                            <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                                <div class="md:col-span-3">
                                    <a href="#" class="flex justify-center md:justify-start focus:outline-none">
                                        <img src="{{ asset('web-assets/images/logo-light.png') }}" class="" alt="">
                                    </a>
                                </div><!--end col-->
