    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="nav-right col-xl-8 col-lg-12 col-auto pull-right right-header p-0">
            <ul class="nav-menus">
                    ...
                    <div class="onhover-show-div notification-dropdown">
                        ...
                        <div class="notification-card">
                            <ul>
                                ...
                                <li>
                                    <div class="user-notification">
                                        <div> <img src="{{ asset('admin-assets/images/avtar/18.jpg') }}" alt="avatar">
                                        </div>
                                        <div class="user-description"><a href="letter-box.html">
                                ...
                                <li>
                                    <div class="user-notification">
                                        <div><img src="{{ asset('admin-assets/images/avtar/19.jpg') }}" alt="avatar">
                                        </div>
                                        <div class="user-description"><a href="letter-box.html">
                                                <h4>Congrats! you all task for today.</h4>
                                            </a><span>Today 06:55pm</span></div>
                ...
                <li class="onhover-dropdown">
                    <svg>
                        <use href="{{ asset('admin-assets/svg/icon-sprite.svg') }}#Bookmark"></use>
                    </svg>
                ...
                <li class="onhover-dropdown">
                    <div class="message position-relative">
                        <svg>
                            <use href="{{ asset('admin-assets/svg/icon-sprite.svg') }}#Message"></use>
                    ...
                    <div class="onhover-show-div message-dropdown">
                        ...
                        <ul>
                            <li>
                                <div class="d-flex align-items-start">
                                    <div class="message-img bg-light-primary"><img
                                            src="{{ asset('admin-assets/images/user/3.jpg') }}" alt=""></div>
                            ...
                            <li>
                                <div class="d-flex align-items-start">
                                    <div class="message-img bg-light-primary"><img
                                            src="{{ asset('admin-assets/images/user/6.jpg') }}" alt=""></div>
                                    <div class="flex-grow-1">
                            ...
                            <li>
                                <div class="d-flex align-items-start">
                                    <div class="message-img bg-light-primary"><img
                                            src="{{ asset('admin-assets/images/user/10.jpg') }}" alt="">
                                    </div>
                                    <div class="flex-grow-1">
                ...
                <li class="cart-nav onhover-dropdown">
                    <div class="cart-box">
                        <svg>
                            <use href="{{ asset('admin-assets/svg/icon-sprite.svg') }}#Buy"></use>
                        </svg>
                    </div>
                        ...
                        <ul>
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 img-50"
                                        src="{{ asset('admin-assets/images/ecommerce/05.jpg') }}" alt="">
                            ...
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 img-50"
                                        src="{{ asset('admin-assets/images/ecommerce/02.jpg') }}" alt="">
