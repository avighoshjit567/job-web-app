    ...
    <div class="container-fluid relative mt-20">
        <div class="grid grid-cols-1">
            <div class="w-full leading-[0] border-0">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3648.577559674752!2d90.38675257533964!3d23.86913007858962!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c419e4d50d6b%3A0x6a16dae10800a953!2sPUL%20Tower!5e0!3m2!1sen!2sbd!4v1753869995150!5m2!1sen!2sbd" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="w-full h-[500px]" allowfullscreen></iframe>
            </div>
        </div><!--end grid-->
    </div><!--end container-->
    <!-- Google Map -->
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                ...
                <div class="text-center px-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <div class="mt-5">
                            <a href="mailto:contact@hirehunt.com"
                                class="inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center relative p-0 border-none after:content-[''] after:absolute after:h-px after:w-0 after:end-0 after:bottom-0 after:start-0 after:transition-all after:duration-500 hover:after:w-full hover:after:end-auto text-emerald-600 hover:text-emerald-600 after:bg-emerald-600">contact@hirehunt.com</a>
                        </div>
                    </div>
                </div>
