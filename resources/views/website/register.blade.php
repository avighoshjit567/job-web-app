            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
                <div
                    ...
                    <div class="p-6">
                        ...
                        @endif
                        <form class="text-start" action="{{ route('user.store') }}" method="POST">
                            @csrf
                            <div class="grid grid-cols-1">
                                <div class="mb-4 text-start">
                                    <label class="font-semibold" for="RegisterName">Your Name:</label>
                                    <input id="RegisterName" name="name" type="text"
                                        class="form-input mt-3 rounded-md" placeholder="Harry">
                                </div>
                                <div class="mb-4 text-start">
                                    <label class="font-semibold" for="LoginEmail">Email Address:</label>
                                    <input id="LoginEmail" type="email" name="email"
                                        class="form-input mt-3 rounded-md" placeholder="name@example.com">
                                </div>
                                ...
                                <div class="mb-4">
                                    <div class="flex items-center mb-0">
                                        ...
                                        <label class="form-checkbox-label text-slate-400" for="Accept:T&C">I Accept <a
                                                href="#" class="text-emerald-600">Terms And Condition</a></label>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <span class="text-slate-400 me-2">Already have an account ? </span> <a
                                        ...
                                        class="text-slate-900 dark:text-white font-bold">Sign in</a>
                                </div>
                            </div>
                        </form>
                    </div>
