            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-5 box-col-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Job Category Edit</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="title"
                                                placeholder="Job Category Title *" value="{{ $category->title }}">
                                            @if ($errors->has('title'))
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="text-end">
                                            ...
                                            <a class="btn btn-danger" href="{{ route('job.category.list') }}">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
